...
// KuKuRoll helps your migrate your existing Uniswap LP tokens to kukuswap LP ones
contract KuKuRoll {
    ...
    function removeLiquidity(
        ...
        require(amountA >= amountAMin, 'KuKuRoll: INSUFFICIENT_A_AMOUNT');
        require(amountB >= amountBMin, 'KuKuRoll: INSUFFICIENT_B_AMOUNT');
    }

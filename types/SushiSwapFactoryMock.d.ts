...
interface kukuswapFactoryMockInterface extends ethers.utils.Interface {
  functions: {
...
export class kukuswapFactoryMock extends Contract {
  ...
  interface: kukuswapFactoryMockInterface;
